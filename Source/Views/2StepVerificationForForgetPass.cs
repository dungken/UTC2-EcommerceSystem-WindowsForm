...
{
    public partial class _2StepVerificationForForgetPass : Form
    {
        public static int frmConfirmEmailLocationFixedY;
        private readonly AccountService _AccountService;
        public static bool isVerifyEmail = false;
        public _2StepVerificationForForgetPass()
        {
            InitializeComponent();
        ...
        private async void btnDone_Click(object sender, EventArgs e)
        {
            ...
            if (result.Success)
            {
                MessageBox.Show("Verify Email successfull");
                isVerifyEmail = true;
                this.Close();
            }
            else
            {
                MessageBox.Show("Verify Email Faile, Your code is not correct");
            }
        }
